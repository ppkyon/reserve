...
from reserve.models import ReserveOfflineSetting, ReserveOnlineSetting, ReserveCalendarUpdate
...
def save(request):
    ...
    elif ShopOnline.objects.filter(display_id=request.POST.get("id")).exists():
