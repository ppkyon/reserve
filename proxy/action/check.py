...
from flow.models import ShopFlow, ShopFlowTab
from reception.models import ReceptionOfflinePlace, ReceptionOnlinePlace
from reserve.models import (
    ReserveBasic, ReserveOfflinePlace, ReserveOnlinePlace, ReserveOfflineCourse, ReserveOnlineCourse, ReserveOfflineSetting, ReserveOnlineSetting,
    ReserveStartDate, ReserveCalendarDate, ReserveCalendarTime, ReserveTempCalendar,
