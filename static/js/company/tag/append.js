function append_genre() {
    ...
    html += '<form id="favorite_text_form" action="/company/tag/genre/favorite/" method="POST" enctype="multipart/form-data" data-parsley-focus="none">';
    ...
    html += '<form id="delete_genre_form" action="/company/tag/genre/delete/" method="POST" enctype="multipart/form-data" data-parsley-focus="none">';
    html += '<input type="hidden" name="id" value="">';
    html += '</form>';
    html += '</div>';
    html += '</div>';
...
function append_tag() {
    ...
    html += '<td>';
    html += '<div class="d-flex justify-content-center align-items-center">';
    html += '<form id="favorite_text_form" action="/company/tag/tag/favorite/" method="POST" enctype="multipart/form-data" data-parsley-focus="none">';
    html += '<input type="hidden" name="id" value="">';
    html += '</form>';
    html += '<img class="favorite-icon" src="' + $( '#env_static_url' ).val() + 'img/icon/star.svg">';
    html += '<img class="favorite-icon d-none" src="' + $( '#env_static_url' ).val() + 'img/icon/star-color.svg">';
    ...
    html += '<form id="delete_tag_form" action="/company/tag/tag/delete/" method="POST" enctype="multipart/form-data" data-parsley-focus="none">';
    html += '<input type="hidden" name="id" value="">';
    html += '</form>';
    html += '</div>';
    html += '</div>';
...
function append_tag_list( response, target ) {
    ...
    $.each( response, function( index, value ) {
        ...
        if ( index == 0 ) {
            ...
            html += '<form id="delete_tag_' + value.display_id + '_form" action="/company/tag/tag/delete/" method="POST" enctype="multipart/form-data" data-parsley-focus="none">';
            html += '<input type="hidden" name="id" value="' + value.display_id + '">';
            html += '</form>';
            html += '</div>';
            html += '</div>';
