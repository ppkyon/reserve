    ...
    for ( var i = 1; i < add_count; i++ ) {
        if ( i >= now_count ) {
            if ( i == 1 ) {
                ...
                html += '<button type="button" class="d-none" data-bs-toggle="modal" data-bs-target="#company_question_modal"></button>'
                html += '</div>'
...
function append_table_area(data) {
    ...
    var button = '<a href="/company/template/richmessage/edit/?id=' + data.display_id + '" class="btn detail-button p-1">詳細</a>';
