...
$( function() {
    ...
    $( '#save_text_form .title-area img' ).on( 'click', function() {
        $( '#save_text_form .title-area img' ).each( function( index, value ) {
            ...
            if ( $( this ).attr( 'src' ).indexOf( 'color' ) !== -1 ) {
                if ( $( this ).hasClass( 'd-none' ) ) {
                    $( '#save_text_form [name=favorite]' ).prop( 'checked', false );
                } else {
                    $( '#save_text_form [name=favorite]' ).prop( 'checked', true );
                }
            } else {
                if ( $( this ).hasClass( 'd-none' ) ) {
                    $( '#save_text_form [name=favorite]' ).prop( 'checked', true );
        ...
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            ...
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    ...
                    html += '<a href="/template/text/edit/?id=' + response.display_id + '" target="_blank">';
        ...
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            ...
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    ...
                    html += '<a href="/template/video/edit/?id=' + response.display_id + '" target="_blank">';
                    html += '<div class="chart-content position-relative mb-0">';
        ...
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            ...
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    ...
                    html += '<a href="/template/richmessage/edit/?id=' + response.display_id + '" target="_blank">';
                    html += '<div class="chart-content position-relative mb-0">';
        ...
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            ...
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    ...
                    html += '<a href="/template/richvideo/edit/?id=' + response.display_id + '" target="_blank">';
                    html += '<div class="chart-content position-relative mb-0">';
        ...
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            ...
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    ...
                    html += '<a href="/template/cardtype/edit/?id=' + response.display_id + '" target="_blank">';
                    html += '<div class="chart-content position-relative mb-0">';
