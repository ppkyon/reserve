function append_input_area() {
    ...
    html += '<button type="button" class="d-none" data-bs-toggle="modal" data-bs-target="#template_text_modal"></button>';
    ...
    html += '<button type="button" class="d-none" data-bs-toggle="modal" data-bs-target="#template_richmessage_modal"></button>';
    html += '<button type="button" value="3" class="btn dropdown-item fw-bold text-center border-top p-1 pt-2">リッチビデオ</button>';
    html += '<button type="button" class="d-none" data-bs-toggle="modal" data-bs-target="#template_richvideo_modal"></button>';
    html += '<button type="button" value="4" class="btn dropdown-item fw-bold text-center border-top p-1 pt-2">カードタイプ</button>';
    html += '<button type="button" class="d-none" data-bs-toggle="modal" data-bs-target="#template_cardtype_modal"></button>';
    html += '</div>';
    html += '</div>';
...
function append_table_area(data) {
    ...
    var button = '<a href="/template/text/edit/?id=' + data.display_id + '" class="btn detail-button p-1">詳細</a>';
    ...
    html += '</td>';
    html += '<td>';
    html += '<form id="favorite_form" action="/template/text/favorite/" method="POST" enctype="multipart/form-data" data-parsley-focus="none">';
