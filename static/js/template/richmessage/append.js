...
function append_table_area(data) {
    ...
    var button = '<a href="/template/richmessage/edit/?id=' + data.display_id + '" class="btn detail-button p-1">詳細</a>';
    ...
    html += '</td>';
    html += '<td>';
    html += '<form id="favorite_form" action="/template/richmessage/favorite/" method="POST" enctype="multipart/form-data" data-parsley-focus="none">';
