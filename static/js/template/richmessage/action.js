$( function() {
    ...
    $( '#save_richmessage_form .title-area img' ).on( 'click', function() {
        $( '#save_richmessage_form .title-area img' ).each( function( index, value ) {
            ...
            if ( $( this ).attr( 'src' ).indexOf( 'color' ) !== -1 ) {
                if ( $( this ).hasClass( 'd-none' ) ) {
                    $( '#save_richmessage_form [name=favorite]' ).prop( 'checked', false );
                } else {
                    $( '#save_richmessage_form [name=favorite]' ).prop( 'checked', true );
                }
            } else {
                if ( $( this ).hasClass( 'd-none' ) ) {
                    $( '#save_richmessage_form [name=favorite]' ).prop( 'checked', true );
