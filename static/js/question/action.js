$( function() {
    ...
    $( '#save_question_form .title-area img' ).on( 'click', function() {
        $( '#save_question_form .title-area img' ).each( function( index, value ) {
            ...
            if ( $( this ).attr( 'src' ).indexOf( 'color' ) !== -1 ) {
                if ( $( this ).hasClass( 'd-none' ) ) {
                    $( '#save_question_form [name=favorite]' ).prop( 'checked', false );
                } else {
                    $( '#save_question_form [name=favorite]' ).prop( 'checked', true );
                }
            } else {
                if ( $( this ).hasClass( 'd-none' ) ) {
                    $( '#save_question_form [name=favorite]' ).prop( 'checked', true );
