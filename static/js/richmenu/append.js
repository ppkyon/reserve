...
function append_table_area(data) {
    ...
    html += '</td>';
    html += '<td>';
    html += '<form id="favorite_form" action="/richmenu/favorite/" method="POST" enctype="multipart/form-data" data-parsley-focus="none">';
    ...
    html += '<td>';
    html += '<input type="hidden" name="id" value="' + data.display_id + '">';
    html += '<a href="/richmenu/edit/?id=' + data.display_id + '" class="btn detail-button p-1">詳細</a>';
    html += '</td>';
    html += '</tr>';
    return html;
}