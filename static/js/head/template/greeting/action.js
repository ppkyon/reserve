...
$( function() {
    ...
    $( document ).on( 'click', '#save_greeting_form .input-template-dropdown .dropdown-menu button', function () {
        if ( $( this ).val() == '0' ) {
    ...
    $( document ).on( 'click', '#head_template_text_modal .table-area tbody button', function () {
        var target = $( this );
        ...
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            ...
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    'data': form_data,
                    'url': $( '#get_head_template_text_url' ).val(),
                    'type': 'POST',
                    'dataType': 'json',
                    'processData': false,
                    'contentType': false,
    ...
    $( document ).on( 'click', '#head_template_video_modal .table-area tbody button', function () {
        ...
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            ...
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    'data': form_data,
                    'url': $( '#get_head_template_video_url' ).val(),
                    'type': 'POST',
                    'dataType': 'json',
                    'processData': false,
                    'contentType': false,
    ...
    $( document ).on( 'click', '#head_template_richmessage_modal .table-area tbody button', function () {
        var target = $( this );
        var id = $( this ).next().val();
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            var number = $( this ).val();
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    'data': form_data,
                    'url': $( '#get_head_template_richmessage_url' ).val(),
                    'type': 'POST',
                    'dataType': 'json',
                    'processData': false,
                    'contentType': false,
    ...
    $( document ).on( 'click', '#head_template_richvideo_modal .table-area tbody button', function () {
        var target = $( this );
        var id = $( this ).next().val();
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            var number = $( this ).val();
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    'data': form_data,
                    'url': $( '#get_head_template_richvideo_url' ).val(),
                    'type': 'POST',
                    'dataType': 'json',
                    'processData': false,
                    'contentType': false,
    ...
    $( document ).on( 'click', '#head_template_cardtype_modal .table-area tbody button', function () {
        var target = $( this );
        var id = $( this ).next().val();
        $( 'form .input-area [name=number]' ).each( function( index, value ) {
            var number = $( this ).val();
            if ( $( target ).val() == number ) {
                ...
                $.ajax({
                    'data': form_data,
                    'url': $( '#get_head_template_cardtype_url' ).val(),
                    'type': 'POST',
                    'dataType': 'json',
                    'processData': false,
                    'contentType': false,
