$( function() {
    ...
    $( document ).on( 'click', '#save_flow_form .chart-area .action-message-button', function () {
        ...
        $( '#action_message_modal .modal-body [name=action_message_template]' ).val( $( '#save_flow_form .target [name=action_message_template]' ).val() );
        $( '#action_message_modal .modal-body [name=action_message_template_item]' ).val( $( '#save_flow_form .target [name=action_message_template_item]' ).val() );
        $( '#action_message_modal .modal-body [name=action_message_template_item_name]' ).val( $( '#save_flow_form .target [name=action_message_template_item_name]' ).val() );

        if ( $( '#save_flow_form .target [name=message_action_template_timer]' ).val() == '1' ) {
            $( '#action_message_modal .modal-body [name=action_message_timer_date]' ).val( $( '#save_flow_form .target [name=action_message_timer_date]' ).val() );
            $( '#action_message_modal .modal-body [name=action_message_timer_date_time]' ).val( $( '#save_flow_form .target [name=action_message_timer_time]' ).val() );
            ...
            $( '#action_message_modal .modal-body [name=action_message_timer_progress]' ).val( $( '#save_flow_form .target [name=action_message_timer_date]' ).val() );
            $( '#action_message_modal .modal-body [name=action_message_timer_progress_time]' ).val( $( '#save_flow_form .target [name=action_message_timer_time]' ).val() );
        } else {
            $( '#action_message_modal .modal-body [name=action_message_timer_date]' ).val( '' );
            $( '#action_message_modal .modal-body [name=action_message_timer_date_time]' ).val( '' );
            $( '#action_message_modal .modal-body [name=action_message_timer_progress]' ).val( '' );
