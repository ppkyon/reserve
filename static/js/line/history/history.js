$( function(){
    ...
    $( document ).on( 'click', '.history-area .history-content-area.active', function () {
        ...
        $.ajax({
            ...
            $( '.check-area .check-place-text' ).text( response.online_offline.title );
            $( '.end-area .end-place-text' ).text( response.online_offline.title );
            if ( check_empty(response.course) ) {
                alert
                $( '.check-area .check-course-text' ).text( response.course.title );
                $( '.end-area .end-course-text' ).text( response.course.title );
            } else {
                $( '.check-area .check-course-text' ).parents( '.content-item-area' ).remove();
                $( '.end-area .end-course-text' ).parents( '.content-item-area' ).remove();
            }
