$( function() {
    $( '.question-area .button-area .check-button' ).on( 'click', function() {
        if ( $( '#question_form' ).parsley().validate() ) {
            ...
            $( '.question-check-area .content-area .content-item-area' ).children().each( function( index, value ) {
                if ( !$( this ).hasClass( 'check-content-item-area' ) ) {
                    $( this ).remove();
                }
            });
            $( '.question-end-area .content-area .content-item-area' ).children().each( function( index, value ) {
            ...
            for ( var i = 1; i <= $( '#question_form' ).children( 'div.row' ).length; i++ ) {
                ...
                html += '</div>';
                $( '.question-check-area .content-area .content-item-area' ).append(html);
                $( '.question-end-area .content-area .content-item-area' ).append(html);
            }
            setTimeout( function() {
