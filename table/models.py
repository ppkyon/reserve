...
class MiniTableSearch(models.Model):
    id = models.CharField(primary_key=True, max_length=255, null=False, blank=False, unique=True)
    url = models.CharField(max_length=255, null=False, blank=False)
    company = models.ForeignKey(AuthCompany, on_delete=models.CASCADE, blank=True, null=True, related_name="mini_table_search")
    shop = models.ForeignKey(AuthShop, on_delete=models.CASCADE, blank=True, null=True, related_name="mini_table_search")
    manager = models.ForeignKey(AuthUser, on_delete=models.PROTECT, related_name="mini_table_search")
...
class MiniTableNumber(models.Model):
    id = models.CharField(primary_key=True, max_length=255, null=False, blank=False, unique=True)
    url = models.CharField(max_length=255, null=False, blank=False)
    company = models.ForeignKey(AuthCompany, on_delete=models.CASCADE, blank=True, null=True, related_name="mini_table_number")
    shop = models.ForeignKey(AuthShop, on_delete=models.CASCADE, blank=True, null=True, related_name="mini_table_number")
    manager = models.ForeignKey(AuthUser, on_delete=models.PROTECT, related_name="mini_table_number")
    page = models.CharField(max_length=255, null=False, blank=False)
    item = models.CharField(max_length=255, null=True, blank=True)
    number = models.IntegerField(null=False, blank=False, default=0)
    updated_at = models.DateTimeField(blank=False, null=True)
...
class MiniTableSort(models.Model):
    sort_choice = (
        (0, 'なし'),
        (1, 'asc'),
        (2, 'desc'),
    ...
    id = models.CharField(primary_key=True, max_length=255, null=False, blank=False, unique=True)
    url = models.CharField(max_length=255, null=False, blank=False)
    company = models.ForeignKey(AuthCompany, on_delete=models.CASCADE, blank=True, null=True, related_name="mini_table_sort")
    shop = models.ForeignKey(AuthShop, on_delete=models.CASCADE, blank=True, null=True, related_name="mini_table_sort")
    manager = models.ForeignKey(AuthUser, on_delete=models.PROTECT, related_name="mini_table_sort")
    page = models.CharField(max_length=255, null=False, blank=False)
    item = models.CharField(max_length=255, null=True, blank=True)
    target = models.CharField(max_length=255, null=False, blank=False)
    sort = models.IntegerField(choices=sort_choice, default=0)
