...
from template.models import ShopTemplateText, ShopTemplateVideo, ShopTemplateRichMessage, ShopTemplateRichVideo, ShopTemplateCardType, ShopTemplateGreeting
...
def save(request):
    ...
    ShopTemplateGreeting.objects.filter(shop=auth_login.shop).all().delete()
    ...
    for i in range(int(request.POST.get('count'))):
        if request.POST.get('message_type_' + str( i + 1 )) == '1':
            ...
            template = ShopTemplateGreeting.objects.create(
                id = str(uuid.uuid4()),
                display_id = create_code(12, ShopTemplateGreeting),
                company = auth_login.shop.company,
                shop = auth_login.shop,
            ...
            template_greeting = ShopTemplateGreeting.objects.create(
                id = str(uuid.uuid4()),
                display_id = create_code(12, ShopTemplateGreeting),
                company = auth_login.shop.company,
                shop = auth_login.shop,
