...
from template.action import text, video, richmessage, richvideo, cardtype, greeting
...
urlpatterns = [
    ...
    path('text/favorite/', text.favorite, name='favorite_text'),
    ...
    path('video/favorite/', video.favorite, name='favorite_video'),
    ...
    path('richmessage/favorite/', richmessage.favorite, name='favorite_richmessage'),
    ...
    path('richvideo/favorite/', richvideo.favorite, name='favorite_richvideo'),
    ...
    path('cardtype/favorite/', cardtype.favorite, name='favorite_cardtype'),
