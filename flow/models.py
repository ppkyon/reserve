...
class UserFlowSchedule(models.Model):
    ...
    temp_manager = models.ForeignKey(AuthUser, on_delete=models.CASCADE, blank=False, null=True, related_name="temp_user_flow_history")
    temp_flg = models.BooleanField(default=False)
    updated_at = models.DateTimeField(blank=False, null=True)
    created_at = models.DateTimeField(default=timezone.now)
