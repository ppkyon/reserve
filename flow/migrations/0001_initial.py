# Generated by Django 4.0 on 2024-03-27 13:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='UserFlowHistory',
            fields=[
                ('id', models.CharField(max_length=255, primary_key=True, serialize=False, unique=True)),
                ('display_id', models.BigIntegerField()),
                ('number', models.IntegerField(default=0)),
                ('type', models.IntegerField(choices=[(1, 'date'), (2, 'pass'), (3, 'offser'), (4, 'manual')], default=0)),
                ('interview', models.IntegerField(choices=[(1, '対面'), (2, 'オンライン')], default=0)),
                ('name', models.CharField(max_length=255, null=True)),
                ...
                ('template_cardtype', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_history', to='template.shoptemplatecardtype')),
                ('template_richmessage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_history', to='template.shoptemplaterichmessage')),
                ('template_richvideo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_history', to='template.shoptemplaterichvideo')),
                ('template_text', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_history', to='template.shoptemplatetext')),
                ('template_video', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_history', to='template.shoptemplatevideo')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_history', to='user.lineuser')),
            ],
            options={
