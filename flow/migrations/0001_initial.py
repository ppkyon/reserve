# Generated by Django 4.0 on 2024-04-16 14:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='UserFlowActionReminder',
            fields=[
                ('id', models.CharField(max_length=255, primary_key=True, serialize=False, unique=True)),
                ('action_date', models.DateTimeField(null=True)),
                ('updated_at', models.DateTimeField(null=True)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('flow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_reminder', to='flow.userflow')),
                ('template_cardtype', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_reminder', to='template.shoptemplatecardtype')),
                ('template_richmessage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_reminder', to='template.shoptemplaterichmessage')),
                ('template_richvideo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_reminder', to='template.shoptemplaterichvideo')),
                ('template_text', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_reminder', to='template.shoptemplatetext')),
                ('template_video', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_reminder', to='template.shoptemplatevideo')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_reminder', to='user.lineuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('flow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_message', to='flow.userflow')),
                ('template_cardtype', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_message', to='template.shoptemplatecardtype')),
                ('template_richmessage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_message', to='template.shoptemplaterichmessage')),
                ('template_richvideo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_message', to='template.shoptemplaterichvideo')),
                ('template_text', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_message', to='template.shoptemplatetext')),
                ('template_video', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_message', to='template.shoptemplatevideo')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_flow_action_message', to='user.lineuser')),
            ],
            options={
