        ...
        for reserve_calendar_update in ReserveCalendarUpdate.objects.filter(flg=True).order_by('created_at').all():
            if reserve_calendar_update.offline:
                ...
                if datetime.datetime(date.year, date.month, date.day, 23, 59, 59) >= datetime.datetime.now():
                    ...
                    for reception_offline_place in ReceptionOfflinePlace.objects.filter(offline=reserve_calendar_update.offline.offline, reception_date__year=date.year, reception_date__month=date.month, reception_date__day=date.day).all():
                        reception_data = list()
                        ...
                        if not reception_offline_place.reception_flg:
                            ...
                            for times in pandas.date_range(start=datetime.datetime(date.year, date.month, date.day, reception_offline_place.reception_from.hour, reception_offline_place.reception_from.minute, 0), end=datetime.datetime(date.year, date.month, date.day, reception_offline_place.reception_to.hour, reception_offline_place.reception_to.minute, 0), freq=str(reserve_calendar_update.offline.unit)+'min'):
                                schedule_time = str(times.hour)+':'+str(times.minute).ljust(2, '0')
                ...
                if datetime.datetime(date.year, date.month, date.day, 23, 59, 59) > datetime.datetime.now():
                    ...
                    for reception_online_place in ReceptionOnlinePlace.objects.filter(online=reserve_calendar_update.online.online, reception_date__year=date.year, reception_date__month=date.month, reception_date__day=date.day).all():
                        reception_data = list()
                        ...
                        if not reception_online_place.reception_flg:
                            ...
                            for times in pandas.date_range(start=datetime.datetime(date.year, date.month, date.day, reception_online_place.reception_from.hour, reception_online_place.reception_from.minute, 0), end=datetime.datetime(date.year, date.month, date.day, reception_online_place.reception_to.hour, reception_online_place.reception_to.minute, 0), freq=str(reserve_calendar_update.online.unit)+'min'):
                                schedule_time = str(times.hour)+':'+str(times.minute).ljust(2, '0')
