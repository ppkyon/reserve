                    ...
                    for i in range(3):
                        if i == 1:
                            if old_user_flow_schedule:
                                date = datetime.datetime(old_user_flow_schedule.date.year, old_user_flow_schedule.date.month, old_user_flow_schedule.date.day, old_user_flow_schedule.time.hour, old_user_flow_schedule.time.minute, 0)
                            else:
                                continue
                        elif i == 2:
                        ...
                        if not date:
                            continue
                        target_date = datetime.datetime(date.year, date.month, date.day, date.hour, date.minute, 0)
